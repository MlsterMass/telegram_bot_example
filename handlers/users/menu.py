...
from keyboards.inline.menu_keyboard import categories_keyboard, menu_cd, item_keyboard, subcategories_keyboard, \
    items_keyboard
...
async def list_of_categories(message: Union[CallbackQuery, Message], **kwargs):
...
async def navigate(call: CallbackQuery, callback_data: dict):
    ...
    levels = {
        "0": list_of_categories,  # Отдаем категории
